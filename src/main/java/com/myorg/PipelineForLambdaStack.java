...
public class PipelineForLambdaStack extends Stack {

    // alternate constructor for calls without props.
    // lambdaCode and repoName are both required.
    public PipelineForLambdaStack(final App scope, final String id, final CfnParametersCode lambdaCode, final String repoName) {
        this(scope, id, null, lambdaCode, repoName);
    }

    @SuppressWarnings("serial")
    public PipelineForLambdaStack(final App scope, final String id, final StackProps props,
